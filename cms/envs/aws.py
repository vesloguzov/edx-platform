...
SERVICE_VARIANT_FOR_MKTG_LINKS = ENV_TOKENS.get('SERVICE_VARIANT_FOR_MKTG_LINKS', SERVICE_VARIANT_FOR_MKTG_LINKS)
...
DEFAULT_COURSE_CATALOG_VISIBILITY = ENV_TOKENS.get('DEFAULT_COURSE_CATALOG_VISIBILITY', DEFAULT_COURSE_CATALOG_VISIBILITY)
