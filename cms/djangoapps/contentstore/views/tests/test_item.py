...
class TestComponentTemplates(CourseTestCase):
    ...
    def test_basic_components(self):
        ...
        """
        self._verify_basic_component("discussion")
        self._verify_basic_component("video")
    ...
    def test_basic_components_support_levels(self):
        ...
        self.templates = get_component_templates(self.course)
        self._verify_basic_component("discussion", "ps")
        ...
        self.templates = get_component_templates(self.course)
        self._verify_basic_component("video", "us")
    ...
    def _verify_basic_component(self, component_type, support_level=True):
        """
