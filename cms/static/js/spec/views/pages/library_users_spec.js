        ...
        describe('read-write access', function() {
            ...
            beforeEach(function(done) {
                ...
                ManageUsersFactory(
                    'Mock Library',
                    [
                        {id: 1, email: "honor@example.com", nickname:"honor", role: 'staff'},
                        {id: 2, email: "audit@example.com", nickname:"audit", role: 'instructor'},
                        {id: 3, email: "staff@example.com", nickname:"staff", role: 'library_user'}
                    ],
                    changeRoleUrl,
                    10000,
                    true
