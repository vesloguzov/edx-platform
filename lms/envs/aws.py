...
# HelpDeskEddy
HELPDESKEDDY_URL = AUTH_TOKENS.get('HELPDESKEDDY_URL')
HELPDESKEDDY_API_KEY = AUTH_TOKENS.get('HELPDESKEDDY_API_KEY')
HELPDESKEDDY_DEPART = AUTH_TOKENS.get('HELPDESKEDDY_DEPART', HELPDESKEDDY_DEPART)
