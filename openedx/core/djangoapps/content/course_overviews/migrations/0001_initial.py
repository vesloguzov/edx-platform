...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('course_overviews_courseoverview', (
            ...
            ('has_active_web_certificates', self.gf('django.db.models.fields.BooleanField')(default=False)),
    ...
    models = {
        'course_overviews.courseoverview': {
            ...
            'has_active_web_certificates': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
