...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('auth_userprofile', 'birthdate',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('auth_userprofile', 'birthdate')
    ...
    models = {
        ...
        'student.userprofile': {
            ...
            'nickname': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'db_index': 'True', 'blank': 'True'}),
