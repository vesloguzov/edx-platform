...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('auth_userprofile', 'nickname',
                      self.gf('django.db.models.fields.CharField')(default='Anonymous', max_length=255, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.nickname'
        db.delete_column('auth_userprofile', 'nickname')
    ...
    models = {
        ...
        'student.userprofile': {
            ...
            'nickname': ('django.db.models.fields.CharField', [], {'default': "'Anonymous'", 'max_length': '255', 'db_index': 'True'}),
