...
class CourseOutlinePage(CoursePage, CourseOutlineContainer):
    ...
    def change_problem_release_date(self):
        ...
        self.q(css="#start_date").fill("2030-01-01")
...
class CourseOutlineModal(object):
    ...
    def release_date(self, date):
        """
        Sets the unit's release date to `date`. Date is "yyyy-mm-dd" string.
        """
    ...
    def due_date(self, date):
        """
        Sets the due date for the unit. Date is "yyyy-mm-dd" string.
        """
