...
class StaffDebugTest(CourseWithoutContentGroupsTest):
    ...
    def test_reset_attempts_empty(self):
        ...
        self.assertEqual(
            u'Successfully reset the attempts for user {}'.format(self.EMAIL), msg
        )
    ...
    def test_delete_state_empty(self):
        ...
        msg = staff_debug_page.idash_msg[0]
        self.assertEqual(
            u'Successfully deleted student state for user {}'.format(self.EMAIL), msg
        )
    ...
    def test_rescore_problem_if_higher(self):
        ...
        msg = staff_debug_page.idash_msg[0]
        self.assertEqual(u'Successfully rescored problem to improve score for user {}'.format(self.EMAIL), msg)
    ...
    def test_student_state_delete(self):
        ...
        staff_debug_page.delete_state()
        msg = staff_debug_page.idash_msg[0]
        self.assertEqual(u'Successfully deleted student state for user {}'.format(self.EMAIL), msg)
